            ...
            var modal = $uibModal.open({
                ...
                template: '<div class="modal-header">\
                        ...
                        <div class="modal-footer">\
                            ...
                            <button class="btn btn-danger" ng-click="modal.dismiss()">No</button>\
                        </div>',
    ...
    .factory('$dialogAlert', function ($uibModal) {
        return function (message, title) {
            var modal = $uibModal.open({
                size: 'sm',
                template: '<div class="modal-header">\
                        <h3 class="modal-title" ng-bind="title"></h3></div>\
                        <div class="modal-body form-label" ng-bind="message"></div>\
                        <div class="modal-footer">\
                            <button class="btn btn-success" ng-click="modal.close()">OK</button>\
                        </div>',
                controller: function ($scope, $uibModalInstance) {
                    $scope.modal = $uibModalInstance;
                    if (angular.isObject(message)) {
